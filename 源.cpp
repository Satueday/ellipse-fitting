...
void OnVideo()
{
	...
	VideoCapture cap("C:/Users/no name/Desktop/test/solo.mp4");
	...
	while (true)
	{
		...
		cout << "--------------------------------" << endl;
		cout << "Total:	         \t" << yaed->GetExecTime() << endl;
		cout << "center:          \t" << yaed->GetCenter() << endl;
		cout << "--------------------------------" << endl;
		...
		yaed->DrawDetectedEllipses(resultImage, ellsYaed);
		cv::circle(resultImage, yaed->GetCenter(), 3, Scalar(0, 0, 255), -1);
...
//int main()
//{
//	string images_folder = "E:/2022_c++/opencv/opencv/flyRobotPT";
//	
//
//	//Mat3b image = imread("C:/Users/no name/Pictures/Saved Pictures/test.png");
//	cout << "1" << endl;
//		Mat3b image = imread("E:/2022_c++/opencv/opencv/PToutput/new1.jpg");
//		Size sz = image.size();
//
//		// Convert to grayscale
//		Mat1b gray;
